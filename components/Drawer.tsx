        ...
        {client && (
          <>
            ...
            <div className="drawer-actions">
              <button className="btn">{Icons.phone}<span>Call</span></button>
              <button className="btn">{Icons.mail}<span>Email</span></button>
              <button className="btn">{Icons.note}<span>Note</span></button>
              <button className="btn btn-primary">{Icons.check}<span>Advance</span></button>
            </div>
          </>
        )}
      </div>
